...
describe('OADAError', function() {
    ...
    it('should accept a title, code, and userMessage', function() {
        var e = new OADAError('title', OADAError.codes.OK, 'message');
    ...
    it('should accept a title, code, userMessage, href', function() {
        var e = new OADAError('title', OADAError.codes.OK, 'message', 'href');
    ...
    it('should accept a title, code, message, href, and detail', function() {
        var e = new OADAError('title', OADAError.codes.OK, 'message', 'href',
        'detail');
    ...
    it('should convert Error to OADAError', function(done) {
        ...
        request(app)
            ...
            .expect(500, function(err, res) {
                ...
                expect(error.title).to.not.equal(e.message);
                expect(error.title).to.equal('Unexpected Error');
                expect(error.href).to.equal(defaultExpected.href);
                expect(error.userMessage).to.equal(defaultExpected.userMessage);
